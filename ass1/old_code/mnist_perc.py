...
class Perceptron:
    ...
    # set target array y_ for individual perceptron
    def set_y(self, y):
        # set target array y_ based on whether each value in the "key" matches the target number
        self.target = np.array([1 if i == self.val else 0 for i in y])       
...
class Perceptron_Manager:
    ...
    def __init__(self, learning_rate, n_iters, acc):
        self.lr = learning_rate
        self.n_it = n_iters
...
test_per1 = Perceptron_Manager(0.00001, 50, Accuracy_train1)
test_per2 = Perceptron_Manager(0.001, 50, Accuracy_train2)
test_per3 = Perceptron_Manager(0.01, 50, Accuracy_train3)

test_per4 = Perceptron_Manager(0.00001, 50, Accuracy_va1)
test_per5 = Perceptron_Manager(0.001, 50, Accuracy_va2)
test_per6 = Perceptron_Manager(0.1, 50, Accuracy_va3)
...
print()
'''
#test_per1._confusion_matrix_(m_data, confusion_1)
