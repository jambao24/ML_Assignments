...
#valid = pd.read_csv('test.csv', header = None) # smaller test file of 420 samples
...
#matplotlib.plot(Accuracy_train1,'b', Accuracy_va1, 'r')
#matplotlib.plot(Accuracy_train2,'b', Accuracy_va2, 'r')
#matplotlib.plot(Accuracy_train3,'b', Accuracy_va3, 'r')
